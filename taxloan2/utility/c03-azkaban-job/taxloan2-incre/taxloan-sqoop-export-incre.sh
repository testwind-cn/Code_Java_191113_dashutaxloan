...
sed  's/${MYSQL_DB}'"/${MYSQL2_DB}/g" sql_before.sql | cat
echo -e "\n=========== MYSQL BEGIN ===========\n"
sed  's/${MYSQL_DB}'"/${MYSQL2_DB}/g" sql_before.sql | mysql -u"${MYSQL2_USER}" -p"${MYSQL2_PASS_S}" -h"${MYSQL2_IP}" -P"${MYSQL2_PORT}"
echo "=========== MYSQL OK ==========="
...
sed  's/${MYSQL_DB}'"/${MYSQL2_DB}/g" sql_after.sql | cat
echo -e "\n=========== MYSQL BEGIN ===========\n"
sed  's/${MYSQL_DB}'"/${MYSQL2_DB}/g" sql_after.sql | mysql -u"${MYSQL2_USER}" -p"${MYSQL2_PASS_S}" -h"${MYSQL2_IP}" -P"${MYSQL2_PORT}"
echo "=========== MYSQL OK ==========="
