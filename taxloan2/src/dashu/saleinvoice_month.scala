...
//    val hc:HiveContext = new HiveContext(sc)
    ...
    val salesInvoiceInfo_tmp1_24month_df:DataFrame = hc.sql(spark.printCmd(constant_full.saleinvoice_month.salesInvoiceInfo_tmp1_24month))
    ...
    val salesInvoiceInfo_tmp1_36month_df:DataFrame = hc.sql(spark.printCmd(constant_full.saleinvoice_month.salesInvoiceInfo_tmp1_36month))
    // hc.sql(s"use ${constant_common.Const_common.DATABASE}")
    ...
    val dim_sellertaxno_24month_df:DataFrame = hc.sql(spark.printCmd(constant_full.saleinvoice_month.dim_sellertaxno_24month))
    // hc.sql(s"use ${constant_common.Const_common.DATABASE}")
    ...
    val dim_sellertaxno_36month_df:DataFrame = hc.sql(spark.printCmd(constant_full.saleinvoice_month.dim_sellertaxno_36month))
    // hc.sql(s"use ${constant_common.Const_common.DATABASE}")
    ...
    val salesInvoiceInfo_tmp1_36month_dim_df:DataFrame = hc.sql(spark.printCmd(constant_full.saleinvoice_month.salesInvoiceInfo_tmp1_36month_dim))
    // hc.sql(s"use ${constant_common.Const_common.DATABASE}")
    ...
    val salesInvoiceInfo_tmp1_24month_dim_df:DataFrame = hc.sql(spark.printCmd(constant_full.saleinvoice_month.salesInvoiceInfo_tmp1_24month_dim))
    // hc.sql(s"use ${constant_common.Const_common.DATABASE}")
    ...
    val salesInvoiceInfo_tmp1_36month_dim_lag_df:DataFrame = hc.sql(spark.printCmd(constant_full.saleinvoice_month.salesInvoiceInfo_tmp1_36month_dim_lag))
    // hc.sql(s"use ${constant_common.Const_common.DATABASE}")
    ...
    val saleinvoice_month_df:DataFrame = hc.sql(spark.printCmd(constant_full.saleinvoice_month.saleinvoice_month))
    // hc.sql(s"use ${constant_common.Const_common.DATABASE}")
