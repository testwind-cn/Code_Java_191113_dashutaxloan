...
object Const_DDL {
  ...
  val create_dim_db: String =loadString.getString("/sql/taxloan2/Const_DDL_Hive/create_dim_db.sql",this)
  ...
  val create_dim_month: String =loadString.getString("/sql/taxloan2/Const_DDL_Hive/create_dim_month.sql",this)
